...
class Point {
	...
	public var map(default, null) : ObjectMap<Dynamic, Dynamic>; //マップ
	public var object(default, null) : Dynamic; //オブジェクト
	public var e(default, null) : Color; //Enum
	
	public function new(x : Int , y : Int, primitive : Primitive, array : Array<Dynamic>, map : ObjectMap<Dynamic,Dynamic>, object : Dynamic ,e : Color) {
		this.x = x;
		this.y = y;
